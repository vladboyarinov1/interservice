  ...
  const cardsInfo = [
    {
      ...
      title: 'Индивидуальный расчет цен',
    },
    {
      id: 2,
      image: <Geolocation height={80} />,
      title: 'Организация доставки оборудования до конечной точки нашими силами',
    },
    {
      id: 3,
      image: <Cards height={70} />,
